  ...
  return (
    <section id="nosotros" className="relative bg-ink py-24 sm:py-32">
      <div className="container-page">
        ...
        <div id="servicios" className="mt-16 grid scroll-mt-24 grid-cols-2 gap-4 sm:gap-5 md:grid-cols-3 lg:grid-cols-4">
          {SERVICES.map((s, i) => (
            <Reveal key={s.id} delay={i * 60}>
              <article className="card-cement group h-full">
                <div className="aspect-[4/3] w-full overflow-hidden">
                  <div className="h-full w-full transition-transform duration-500 group-hover:scale-105">
                    <PlaceholderImage tag="Aplicación" label={s.title} seed={i} />
                  </div>
                </div>
                <div className="p-4">
                  ...
                  <p className="mt-1 text-sm text-cement-light">{s.desc}</p>
                </div>
